...
const News = (props) => {
  ...
  return (
    <>
      ...
      >
        InBrief - Top {capitalizeFirstLetter(props.category)} Headlines
      </h1>
      {loading && <Spinner />}
      {showDialog && (
        <dialog
          ref={dialog}
          className="card border-dark col-md-6 rounded-3"
          style={{ zIndex: "50", position: "fixed", inset: "0", top: "48px" }}
        >
